...
export class EFriendRest extends EFriendRestBase {
     ...
     * @param {typeRest.VTCE1001U_RESPONSE} response               응답
    ...
    public async VTCE1001U(
        ...
        response: typeRest.VTCE1001U_RESPONSE | null = null): Promise<typeRest.VTCE1001U_RESPONSE> {
            return await this.request(secret, 'VTCE1001U', requestHeader, requestBody, response);
        }
     ...
     * @param {typeRest.VTCE1002U_RESPONSE} response               응답
    ...
    public async VTCE1002U(
        ...
        response: typeRest.VTCE1002U_RESPONSE | null = null): Promise<typeRest.VTCE1002U_RESPONSE> {
            return await this.request(secret, 'VTCE1002U', requestHeader, requestBody, response);
        }
     ...
     * @param {typeRest.VTTS3018R_RESPONSE} response               응답
    ...
    public async VTTS3018R(
        ...
        response: typeRest.VTTS3018R_RESPONSE | null = null): Promise<typeRest.VTTS3018R_RESPONSE> {
            return await this.request(secret, 'VTTS3018R', requestHeader, requestBody, response);
        }
