...
export class Accounting {                            
    ...
    protected exchangeFee: number = 0.0140527 / 100;        //--- 매매 수수료율 (코스피/코스닥/코넥스)
    protected exchangeFee_etf: number = 0.0146527 / 100;    //--- 매매 수수료율 (ETF/ETN)
    protected exchangeFee_elw: number = 0.0146527 / 100;    //--- 매매 수수료율 (ELW)
    protected exchangeFee_kotc: number = 0.1498527 / 100;   //--- 매매 수수료율 (K-OTC)
    protected exchangeFee_lender: number = 0.1 / 100;       //--- 매매 수수료율 (대주)
    protected relateFee: number = 0.00363960 / 100;         //--- 유관기관 수수료율
    protected depositFee: number = 0.4 / 100;               //--- 예탁금 이자 (50만원 이상 예치시)

    protected specialTax: number = 0.15 / 100;              //--- 농어촌특별세율 : 0.15%
    protected investTax: number = 0.0;                      //--- 금융투자소득세율 (2025년 도입 예정)
     ...
     * @returns 
     */
    public _feeExchange(totalPrice: number, _type: string = ''): number {
        //--- 상속받아서 구현 한다.
