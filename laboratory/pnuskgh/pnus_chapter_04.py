...
class CNN01(MODEL_BASE):
    ...
    def run_208_211(self):
        ...
        im = cv2.resize(cv2.imread(f'{self.foldername}/cat.jpg'), (244, 244)).astype(np.float32)
        # im = im.transpose((2,0,1))
        im = np.expand_dims(im, axis=0)
        
        # ValueError: Input 0 of layer "sequential" is incompatible with the layer: expected shape=(None, 224, 224, 3), found shape=(None, 3, 244, 244)
